...
describe('Namehash', () => {
  describe('EIP-137', () => {
    ...
    it('should return namehash for subdomain', () => {
      const expectedNamehash = '0x22d0b0ff9a317f337bb5a5e41b2ac550132d661c1af0036d8fc4881928210136';
  ...
  describe('ZNS', () => {
    ...
    it('should return namehash for subdomain', () => {
      const expectedNamehash = '0xe7572940cb7c826a1edfc2c2aea8bbcc4b17f6b5a3ae3e13371aa39f6deea748';
