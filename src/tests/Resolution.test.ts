  ...
  describe('.Basic setup', () => {
      ...
      describe('.Errors', () => {
        ...
        describe('.Namehash errors', () => {
          it('should be invalid domain', async () => {
            ...
            await expectResolutionErrorCode(
              () =>
                resolution.namehash(ensInvalidDomain, NamingServiceName.ENS),
              ResolutionErrorCode.UnsupportedDomain,
            );
            await expectResolutionErrorCode(
              () =>
                resolution.namehash(znsInvalidDomain, NamingServiceName.ZNS),
              ResolutionErrorCode.UnsupportedDomain,
            );
          });
        });
    ...
    describe('.namehash', () => {
      ...
      it('brad.eth', () => {
        ...
        const namehash = resolution.namehash('brad.eth', NamingServiceName.ENS);
        expect(namehash).toEqual(expectedNamehash);
      });
    });
