export default {
  ...
  USDT_ERC20: 'crypto.USDT.version.ERC20.address',
  USDT_TRON: 'crypto.USDT.version.TRON.address',
  USDT_OMNI: 'crypto.USDT.version.OMNI.address',
  USDT_EOS: 'crypto.USDT.version.EOS.address',
