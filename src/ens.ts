...
export default class Ens {
	...
	_resolverCallToName = (resolverContract, nodeHash) => resolverContract.methods.name(nodeHash).call();
	_getResolver = (nodeHash) => this.ensContract.methods.resolver(nodeHash).call();
	_getResolutionInfo = async (nodeHash) => await Promise.all([
