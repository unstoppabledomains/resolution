...
it('resolves .xyz name using ENS blockchain', async () => {
  ...
  const secondSpy = jest
    ...
    .mockImplementation(
      () =>
        new Promise((resolve, reject) =>
          resolve('0xb0E7a465D255aE83eb7F8a50504F3867B945164C'),
        ),
    );
...
it('resolves .luxe name using ENS blockchain', async () => {
  ...
  const secondSpy = jest
    ...
    .mockImplementation(
      () =>
        new Promise((resolve, reject) =>
          resolve('0xf3dE750A73C11a6a2863761E930BF5fE979d5663'),
        ),
    );
...
it('resolves .luxe name using ENS blockchain null', async () => {
  ...
  const secondSpy = jest
    .spyOn(namicorn.ens, 'fetchAddress')
    .mockImplementation(() => new Promise((resolve, reject) => resolve(null)));
